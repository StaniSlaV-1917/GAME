<template>
  <div class="news-page">
    ...
    <div v-if="loading" class="loading-indicator">Загрузка новостей...</div>
...
const fetchNews = async () => {
  ...
  try {
    ...
    newsItems.value = response.data.data; // Используем .data из-за пагинации
  } catch (err) {
...
.news-title { font-size: 1.4rem; font-weight: 600; line-height: 1.4; margin: 0 0 10px; flex-grow: 1; }
