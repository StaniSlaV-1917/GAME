      ...
      <div class="game-info">
        ...
        <div class="game-bottom">
          ...
          <div class="game-actions">
            <button class="game-buy-btn" type="button" @click="addToCart(game.id)">В корзину</button>
...
.game-card-inner:hover {
  ...
  border-color: #3b82f6;
  box-shadow: 0 18px 40px rgba(0,0,0,0.6), 0 0 25px rgba(59, 130, 246, 0.4);
}
...
.external-link-icon { 
  ...
  background: rgba(17, 24, 39, 0.7); backdrop-filter: blur(4px); color: #9ca3af;
...
.game-price { font-weight: 700; font-size: 1.1rem; color: #4ade80; /* Яркий зеленый */ }
...
.game-buy-btn:hover { filter: brightness(1.15); transform: scale(1.05); }
